...
from account.views import (
    RegistrationView, ActivateView, ActivationConfirm, GetCSRFTokenView, LoginView, LogoutView,UserDetailView,
    ChangePasswordView, DeleteAccountView, ResetPasswordEmailView, ResetPasswordView, ResetPasswordConfirmView,
...
urlpatterns = [
    ...
    path('account/reset_password/', ResetPasswordEmailView.as_view(), name='reset_email_password'),
